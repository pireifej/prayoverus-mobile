const translations = {
  en: {
    ...
    emptyHidePrayed: "You've prayed for everything here! ✓ Uncheck \"Hide Prayed\" to see all requests.",
    ...
    everyone: '🌍 Everyone',
    shareWithCommunity: 'Share your prayer request with the community...',
    postPrayerRequest: '🙏 Post Prayer Request',
    updatePrayerRequest: 'Update Prayer Request',
    posting: 'Posting...',
  ...
  es: {
    ...
    emptyHidePrayed: '¡Ya oraste por todo! ✓ Desmarca "Ocultar oradas" para ver todas las peticiones.',
    ...
    editPrayerHint: 'Edita tu petición de oración a continuación',
    heartPrompts: [
      '¿Qué hay en tu corazón hoy?',
      '¿En qué estás confiando en Dios ahora mismo?',
      '¿A quién puedes levantar en oración hoy?',
      '¿Qué carga puedes dejar a Sus pies?',
      '¿Qué milagro estás creyendo que Dios hará?',
      '¿Dónde necesitas la paz de Dios?',
      '¿Por qué estás agradecido hoy?',
      '¿Quién necesita tus oraciones ahora?',
      '¿Qué le estás pidiendo a Dios hoy?',
      '¿Dónde necesitas la fortaleza de Dios?',
    ],
    ...
    everyone: '🌍 Todos',
    shareWithCommunity: 'Comparte tu petición de oración con la comunidad...',
    postPrayerRequest: '🙏 Publicar Petición',
    updatePrayerRequest: 'Actualizar Petición',
    posting: 'Publicando...',
